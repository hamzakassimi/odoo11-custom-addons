...
class hr_employee(models.Model):
	...
	RIBMA = fields.Integer(string="RIB",default=0)
	BANQUEMA = fields.Char(string="Banque", required=False)
	ths = fields.Integer(string="Taux horaire dh/h",default=0)
	htrv = fields.Integer(string="Les heures travaillées",default=0)
