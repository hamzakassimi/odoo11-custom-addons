...
class hr_employee(models.Model):
	...
	nom_arabe = fields.Char(string="Nom Arabe", required=False)
	prenom_arabe = fields.Char(string="Prénom Arabe", required=False)
	rib = fields.Char(string="RIB", required=False)
	banque = fields.Char(string="Banque", required=False)
